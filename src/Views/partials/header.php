  ...
  <div class="container">
    ...
    <nav class="nav-links" data-nav>
      ...
      <div class="nav-item" data-dropdown="explore">
        <button class="nav-link nav-trigger" data-dropdown-toggle="explore" aria-label="Explore menu" aria-haspopup="true" aria-expanded="false">
          Explore <span aria-hidden="true"></span>
        </button>
        <div class="nav-menu" data-menu="explore" hidden role="menu" aria-label="Explore">
      ...
      <div class="nav-item" data-dropdown="account">
        <button class="nav-link nav-trigger" data-dropdown-toggle="account" aria-label="Account menu" aria-haspopup="true" aria-expanded="false">
          Account <span aria-hidden="true"></span>
        </button>
        <div class="nav-menu" data-menu="account" hidden role="menu" aria-label="Account">
