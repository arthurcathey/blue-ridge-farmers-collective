...
<section class="form-card">
  ...
  <?php if ($application !== null): ?>
    <div class="card form-section">
      ...
      <span><?= h($status === '' ? 'pending' : $status) ?></span>
      <?php if (!empty($application['applied_date_ven'])): ?>
        <div>Applied on <?= h((string) $application['applied_date_ven']) ?></div>
      <?php endif; ?>
      <?php if (!empty($application['admin_notes_ven'])): ?>
        <div>Admin note: <?= h((string) $application['admin_notes_ven']) ?></div>
      <?php endif; ?>
    </div>
  <?php endif; ?>
  ...
  <?php elseif (!$canApply): ?>
    <p>Your application is being reviewed. You can update it after a decision.</p>
  <?php endif; ?>
